                                                                ...
                                                                <tbody><!--ตัวตาราง-->
                                                                    ...
                                                                    while ($arrSelWorkFromTeam = $querySelWorkFromTeam->fetch_array()) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <!--เวลายกมา-->
                                                                        <?php
                                                                        $sqlSumDaily = "SELECT MAX(daily_id), daily_sum_time, daily_sum_rec, daily_rec_insert FROM daily  WHERE project_id = '$arrSelWorkFromTeam[project_id];' ";
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <td><?php
                                                                                ...
                                                                                echo "<div align='right'>".number_format($sumUseTime)."</div>";
                                                                                 ?>
                                                                                <input disabled="" id="hdfSumUseTime<?php echo $i; ?>" type="hidden" name="hdfSumUseTime[]" value="<?php echo $sumUseTime; ?>">   
                                                                            </td>
                                                                            <!--รายการบันทึก ยกมา-->
                                                                            <td>
